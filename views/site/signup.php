...
$this->title = 'Регистарция';
?>
<div class="site-login">
    <h2><?= Html::encode($this->title) ?></h2>

    <p>Уже есть аккаунт? <a style="color: black" href="<?php echo yii\helpers\Url::toRoute(['/site/login']) ?>">Войдите</a></p>
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <?= $form->field($model, 'email', ['template' => '{input}'])->Input('email', array('placeholder' => 'E-mail', 'class' => 'ii')) ?>

            <?= $form->field($model, 'role', ['template' => '{input}'])->dropdownList(Roles::find()->select(['name', 'id'])->indexBy('id')->column(),array('placeholder' => 'E-mail', 'class' => 'ii'));?>
            ...
            <div class="form-group">
                <div>
                    <?= Html::submitButton('Регистрация', ['class' => 'btn btnn-log', 'name' => 'login-button']) ?>
                </div>
            </div>
